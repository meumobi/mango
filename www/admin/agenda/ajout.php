...
if(!empty($_GET['id'])){
	...
	$res = donnee("m_agenda","id",$_GET['id'],$condition2,$valeur2,$mysql_link);
...
<div class="wSite">
		...
		<?php echo $ariane = fil_ariance("admin","../","Agenda","index.php?id_rubrique=".$_GET['id_rubrique'],"Ajouter / Modifier","","",""); ?>
