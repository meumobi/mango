...
if(!empty($_GET['id'])){
	...
	$res = donnee("m_editorial","id",$_GET['id'],$condition2,$valeur2,$mysql_link);
...
<div class="wSite">
		...
		<?php echo $ariane = fil_ariance("admin","../",rubrique($_GET['id_rubrique'],$mysql_link),"index.php?id_rubrique=".$_GET['id_rubrique'],"Ajouter / Modifier","","",""); ?>
		...
		<?php 
		 if($_GET['id_rubrique'] == 17){
		 	require("../../lib/formulaire/n_form-diaporama.php"); 
		 }else{
			require("../../lib/formulaire/n_".$res_form["formulaire"]); 
		 }
		?>
