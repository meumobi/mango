            ...
            <div class="mod right mtl">
                <nav id="navigation" role="navigation">
                    <ul class="unstyled inbl p-reset mtm">
                        <li class="left mr2"><a href="/news/" title="L'actualité du surf" class="menu-mango-desktop <?php if($rubrique == 1) echo 'menu-mango-hover-desktop'; ?>">L'actualité du surf</a></li>
                        ...
                        <li class="left mr2"><a href="/galerie-photo/" title="Photos de surf" class="menu-mango-desktop <?php if($rubrique == 17) echo 'menu-mango-hover-desktop'; ?>">Zoom</a></li>
                        <li class="left mr2"><a href="/trip-surf/" title="Surf Trip" class="menu-mango-desktop <?php if($rubrique == 3) echo 'menu-mango-hover-desktop'; ?>">Trip surf</a></li>
                        <li class="left mr2"><a href="/shopping/" title="Shop'in" class="menu-mango-desktop <?php if($rubrique == 15) echo 'menu-mango-hover-desktop'; ?>">Shop'in</a></li>
                        ...
                        <li class="left mr2"><a href="/annuaire/" title="Annuaires" class="menu-mango-desktop <?php if($rubrique == 14) echo 'menu-mango-hover-desktop'; ?>">Annuaire</a></li>
...
<?php } else { ?>
    ...
    <nav id="menu">
        ...
        <ul>
            <li><a href="/news/" class="lnk-menu <?php if($rubrique == 1) echo 'menu-mango-hover'; ?>" title="L'actualité du surf">L'actualité du surf</a></li>
            <li><a href="/video/" class="lnk-menu <?php if($rubrique == 9) echo 'menu-mango-hover'; ?>" title="Vidéos de surf surf">Videos</a></li>
            <li><a href="/galerie-photo/" class="lnk-menu <?php if($rubrique == 17) echo 'menu-mango-hover'; ?>" title="Photos de surf">Zoom</a></li>
            <li><a href="/trip-surf/" class="lnk-menu <?php if($rubrique == 3) echo 'menu-mango-hover'; ?>" title="Surf Trip">Trip surf</a></li>
            <li><a href="/shopping/" class="lnk-menu <?php if($rubrique == 15) echo 'menu-mango-hover'; ?>" title="Shop'in">Shop'in</a></li>
