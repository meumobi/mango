...
jQuery(function($){
	$.datepicker.regional['es'] = {
		...
		dayNamesShort: ['Dom','Lun','Mar','MiÃ©','Juv','Vie','Sáb'],
...
jQuery(function($){
	$.datepicker.regional['pt-BR'] = {
		...
		dayNames: ['Domingo','Segunda-feira','TerÃ§a-feira','Quarta-feira','Quinta-feira','Sexta-feira','Sábado'],
...
jQuery(function($){
	$.datepicker.regional['ro'] = {
		closeText: 'Ãnchide',
		prevText: '« Luna precedentÄ',
		nextText: 'Luna urmÄtoare »',
		currentText: 'Azi',
