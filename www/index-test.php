...
<div class="wSite">
    ...
    while($res = mysqli_fetch_array($query)){
        ...
        $req_news = "SELECT id, id_rubrique, userfile2, userfile3, titre, chapeau, date_publication, nom_fichier FROM m_editorial WHERE id NOT IN (".$res['id'].") AND date_publication < NOW() AND en_ligne = 1 AND id_rubrique NOT IN (4) AND id_cat NOT IN (11,12,13,14,48,49) ORDER BY date_publication DESC LIMIT 0,9";
