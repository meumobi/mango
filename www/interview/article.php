...
<title>Interview - <?php echo $res['titre']; ?></title>	
<link rel="canonical" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/interview/'.$res['nom_fichier'].'--'.$res['id'].'.html'; ?>" />
...
<div class="wSite">
    <?php echo fil_ariance("L'actualité du surf","../",rubrique(2,$mysql_link),"../news/",tronquer(stripslashes($res['titre']),80),"","",""); ?>
