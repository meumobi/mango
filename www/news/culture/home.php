...
<link rel="canonical" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/news/culture/s-'.$res['nom_fichier'].'--'.$res['id'].'.html'; ?>" />
...
<div class="wSite">
    <?php echo fil_ariance("Accueil","../../","News","../",tronquer(stripslashes($res['titre']),80),"","","",""); ?>
