...
<link rel="canonical" href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/news/locale/'.$res['nom_fichier'].'--'.$res['id'].'.html'; ?>" />
...
<div class="wSite">
    <?php echo fil_ariance("L'actualité du surf","../../",rubrique(1,$mysql_link),"../",tronquer(stripslashes($res['titre']),80),"","",""); ?>
